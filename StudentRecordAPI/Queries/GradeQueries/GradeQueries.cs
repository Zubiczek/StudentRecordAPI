...
namespace StudentRecordAPI.Queries.GradeQueries
{
    public class GradeQueries : IGradeGetQueries, IGradePostQueries
    {
        ...
        public async Task<float> GetAverageGradeFromSubject(int Subject_id)
        {
            string userid = _loggedInUserService.GetUserId();
            float gradeavg = 0;
        ...
        public async Task<List<GradeInfoDTO>> GetGradesFromSubject(int Subject_id)
        {
            string userid = _loggedInUserService.GetUserId();
        ...
        public async Task<GradeMoreInfoDTO> GetInfoAboutGrade(int Grade_id)
        {
        ...
        public async Task DeleteGrade(int Grade_id)
        {
        ...
        public async Task UpdateGrade(int Grade_id, float Grade)
        {
